 ...
 */
public class MophiAdapter extends BaseAdapter {

    ArrayList<PatientInfo> mData;
    Context mContext;
    int resElement;

    public MophiAdapter(Context context, int resource, ArrayList<PatientInfo> data) {
    ...
    class MyHolder{
        ...
        public MyHolder(View view) {
            titleTxt = (TextView) view.findViewById(R.id.txt_p_name);
            subtitleTxt1 = (TextView) view.findViewById(R.id.txt_p_id);
