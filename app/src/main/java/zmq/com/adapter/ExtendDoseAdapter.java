 ...
 */
public class ExtendDoseAdapter extends BaseAdapter {

    ArrayList<PatientInfo> mData;
    Context mContext;
    int resElement;

    public ExtendDoseAdapter(Context context, int resource, ArrayList<PatientInfo> data) {
    ...
    class MyHolder{
        ...
        public MyHolder(View view) {
            titleTxt = (TextView) view.findViewById(R.id.txt_extend_dose_p_name);
            subtitleTxt1 = (TextView) view.findViewById(R.id.txt_extend_dose_p_id);
