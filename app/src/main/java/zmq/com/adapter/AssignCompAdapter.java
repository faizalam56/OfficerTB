 ...
 */
public class AssignCompAdapter extends BaseAdapter {

    ArrayList<PatientInfo> mData;
    Context mContext;
    int resElement;

    public AssignCompAdapter(Context context, int resource, ArrayList<PatientInfo> data) {
    ...
    class MyHolder{
        ...
        public MyHolder(View view) {
            titleTxt = (TextView) view.findViewById(R.id.txt_assign_p_name);
            subtitleTxt1 = (TextView) view.findViewById(R.id.txt_assign_p_id);
